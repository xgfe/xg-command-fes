...
function createPEM(pem, host) {
    ...
    console.log(pemShellFile);

    fsExtra.outputFileSync(pemShell, pemShellFile, { mode: 0o500 });
    fsExtra.outputFileSync(pemKey, pem, { mode: 0o600 });
    return {
        dir: pemDir,
        sh: pemShell,
        key: pemKey,
